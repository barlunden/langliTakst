...
export default [
  ...
  },
  {
    ...
    tittel: "Energirådgivning for bolig",
    avsnitt1:
      "De fleste kan spare mye på å iverksette ulike tiltak for å spare strøm eller produsere energi på en smartere måte. Dette kan inkludere alt fra etterisolering og tetting av vinduskarmer til installasjon av solcellepanel og varmepumpesystem.",
    avsnitt2: "",
    ikon: "",
    bilde: "",
  },
  {
    kategori: "energiOgMiljo",
    tittel: "Enovatilskuddet",
    avsnitt1: "Enovatilskuddet gir støtte til gode energi- og klimatiltak.",
    avsnitt2:
